...
% %define two vectors (with 180 angle between them, i.e., parallel vectors)
% A = [5   3  7];
% B = [-5 -3 -7];
...
% calculate the cross product, i.e., find out the vector that is
...
%prove that the vector resulting from the dot product is actually
%perpendicular to both A and B
